...
//
//	//	// Eat:
//	//	tile->forceLocalDirection = LOCAL_DIRECTION_ERROR;
//
//	//	// Go to next tile:
...
//	//	forceEaters[i].tileIndex = tile->sideInfos.neighborTilePtrs[forceEaters[i].heading]->index;
...
//
//	//	Tile* nextTile = tile->sideInfos.neighborTilePtrs[heading];
//
//	//	// go to the next tile:
